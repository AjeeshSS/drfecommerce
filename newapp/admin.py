...
from .models import Attribute, AttributeValue, Category, ProductImage, ProductLine, ProductType


class EditLinkInlline(object):
...
class ProductLineInline(EditLinkInlline, admin.TabularInline):
    model = ProductLine
